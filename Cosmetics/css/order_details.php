<?php 
  ...
  require_once __DIR__ . '/../config/function_details_order.php';
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><?php echo $row['productorder'] ?></td>
            <td><?php echo $row['name'] ?></td>
            <td><?php echo $row['price'] ?></td>
            <td><?php echo $row['quantity'] ?></td>
            <td><a href="delete_page_details_order.php?id=<?php echo $row['id']; ?>&confirm=true" onclick="return confirm('Are you sure delete this?')" class="btn btn-danger">Delete</a></td>
